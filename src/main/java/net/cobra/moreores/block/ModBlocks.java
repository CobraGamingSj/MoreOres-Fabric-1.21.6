...
public class ModBlocks {
    ...
    public static final Block GEM_POLISHER_BLOCK = register("gem_polisher_block", new GemPolisherBlock(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreOresModInitializer.MOD_ID, "gem_polisher_block"))).strength(5f).strength(2.75f, 3f).luminance(state -> state.get(GemPolisherBlock.REDSTONE_POWERED) ? 5 : 0).requiresTool().nonOpaque().sounds(BlockSoundGroup.HEAVY_CORE)));
